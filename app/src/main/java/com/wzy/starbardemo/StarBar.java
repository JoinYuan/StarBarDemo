...
public class StarBar extends View {
    ...
    private Bitmap rating_small_half;//半颗星星
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.rating_small_half = drawableToBitmap(mTypedArray.getDrawable(R.styleable.RatingBar_ratingSmallHalf));
    ...
    public void setBackground(int rating_small_half) {
